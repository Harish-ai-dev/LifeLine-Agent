  ...
  return (
    <div className="w-full pt-28 pb-24 bg-slate-50 dark:bg-[#0B1120] text-slate-800 dark:text-slate-100 font-sans">
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 space-y-12 font-mono text-xs">
        ...
        <div>
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-cyan-400 text-xs uppercase tracking-wider mb-4">
