          ...
          {currentUser.role === 'hospital_staff' && (
            <div className="relative ml-2 hidden md:block">
              ...
              >
                ...
                <span className="text-[10px] px-1.5 py-0.2 rounded bg-sky-100 text-sky-800 font-bold shrink-0">
              ...
              {isFacilityMenuOpen && (
                <div className="absolute left-0 mt-2 w-96 bg-white border border-slate-200 rounded-2xl shadow-2xl p-2.5 z-50 space-y-1.5 animate-in fade-in zoom-in-95 duration-100">
                  ...
                  {hospitals.map((h) => (
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        <div className="font-semibold text-slate-900 leading-snug whitespace-normal break-words">
                          {h.name}
                        </div>
                      ...
                      <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-slate-100 text-slate-700 shrink-0 self-start">
                        {h.tier}
                      </span>
                    </Link>
                  ))}
