      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10">
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-10 font-mono text-xs">
            ...
            {/* Quickstart */}
            <section className="p-6 rounded-3xl bg-[#0F172A] border border-slate-800 space-y-4">
...
cp .env.example .env
# Set GEMINI_API_KEY, OSRM_URL, and NEXT_PUBLIC_SUPABASE_ANON_KEY
...
python -m lifeline.server --port 8000`}
                ...
                <button
                  ...
                  className="absolute top-3 right-3 p-1.5 rounded bg-slate-800 text-slate-300 hover:text-white"
                >
...
pytest tests/agents/test_gemini_schemas.py --benchmark`}
          ...
          <div className="lg:col-span-4 space-y-6 font-mono text-xs">
            <div className="p-6 rounded-2xl bg-[#0F172A] border border-slate-800 space-y-3">
              <h3 className="text-sm font-bold text-white uppercase tracking-wider">Repository Specs</h3>
              <div className="space-y-2 text-slate-300">
                ...
                <div className="flex justify-between pb-1 border-b border-slate-800">
                  <span>Python:</span>
                  <strong className="text-white">3.11+</strong>
                </div>
                <div className="flex justify-between pb-1 border-b border-slate-800">
                  <span>FastAPI:</span>
                  <strong className="text-white">0.110.0</strong>
                </div>
                <div className="flex justify-between pb-1 border-b border-slate-800">
              ...
              <a
                ...
                className="mt-4 w-full py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700 flex items-center justify-center space-x-2"
              >
